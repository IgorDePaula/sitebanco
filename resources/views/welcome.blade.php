           ...
           <nav class="relative z-50 flex justify-between">
               <div class="flex items-center md:gap-x-12"><a aria-label="Home" href="/#">
                   ...
                   <div class="hidden md:flex md:gap-x-6"><a
                           ...
                           href="/#features">Sobre a AMS Capital</a><a
                           class="inline-block rounded-lg py-1 px-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900"
                           href="/#testimonials">Invista com a AMS Capital</a><a
                           class="inline-block rounded-lg py-1 px-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900"
                           href="/#pricing">Serviços de consultoria</a></div>
               </div>
               <div class="flex items-center gap-x-5 md:gap-x-8">
                   <div class="hidden md:block"><a
                           class="inline-block rounded-lg py-1 px-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900"
                           href="/login">Entrar</a></div>
                   <a class="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-blue-600 text-white hover:text-slate-100 hover:bg-blue-500 active:bg-blue-800 active:text-blue-100 focus-visible:outline-blue-600"
                      href="/register"><span>Novo registro</span></a>
                   <div class="-mr-1 md:hidden">
                       <div>
                           <button
                               class="relative z-10 flex h-8 w-8 items-center justify-center [&amp;:not(:focus-visible)]:focus:outline-none"
                               aria-label="Toggle Navigation" id="headlessui-popover-button-:R74m:" type="button"
                               aria-expanded="false">
   ...
   <main>
       <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
           <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
               Empréstimos<!-- --> <span class="relative whitespace-nowrap text-blue-600"><svg aria-hidden="true"
                                                                                               viewBox="0 0 418 42"
                       ...
                       class="relative">feito simples</span></span> <!-- -->para pequenos negócios.
           </h1>
           ...
           <div class="mt-36 lg:mt-44"><p class="font-display text-base text-slate-900">Trusted by these six companies
                   so far</p>
               <ul role="list"
                   ...
                   <li>
                       <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                           <li class="flex"><img alt="Transistor" src="/_next/static/media/transistor.7274e6c3.svg"
                                                 width="158" height="48" decoding="async" data-nimg="future"
                                                 loading="lazy"/></li>
                           <li class="flex"><img alt="Tuple" src="/_next/static/media/tuple.74eb0ae0.svg" width="105"
                                                 height="48" decoding="async" data-nimg="future" loading="lazy"/></li>
                           <li class="flex"><img alt="StaticKit" src="/_next/static/media/statickit.d7937794.svg"
                                                 width="127" height="48" decoding="async" data-nimg="future"
                                                 loading="lazy"/></li>
                       </ul>
                   </li>
                   <li>
                       <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                           <li class="flex"><img alt="Mirage" src="/_next/static/media/mirage.18d2ec4e.svg" width="138"
                                                 height="48" decoding="async" data-nimg="future" loading="lazy"/></li>
                           <li class="flex"><img alt="Laravel" src="/_next/static/media/laravel.7deed17e.svg"
                                                 width="136" height="48" decoding="async" data-nimg="future"
                                                 loading="lazy"/></li>
                           <li class="flex"><img alt="Statamic" src="/_next/static/media/statamic.6da5ebfb.svg"
                                                 width="147" height="48" decoding="async" data-nimg="future"
                                                 loading="lazy"/></li>
                       </ul>
                   </li>
               </ul>
       ...
       <section id="features" aria-label="Features for running your books"
                class="relative overflow-hidden bg-blue-600 pt-20 pb-28 sm:py-32"><img alt=""
                                                                                       src="/_next/static/media/background-features.5f7a9ac9.jpg"
                                                                                       width="2245" height="1636"
                                                                                       decoding="async"
                                                                                       data-nimg="future"
                                                                                       class="absolute top-1/2 left-1/2 max-w-none translate-x-[-44%] translate-y-[-42%]"
                                                                                       loading="lazy"/>
           <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
               <div class="max-w-2xl md:mx-auto md:text-center xl:max-w-none"><h2
                       class="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">Tudo o que voce
                       precisa saber para nos conhecer</h2>
                   <p class="mt-6 text-lg tracking-tight text-blue-100">Well everything you need if you aren’t that
                       picky about minor details like tax compliance.</p></div>
               <button type="button" aria-hidden="true"
                       style="position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border-width:0"></button>
               <div
                   class="mt-16 grid grid-cols-1 items-center gap-y-2 pt-10 sm:gap-y-6 md:mt-20 lg:grid-cols-10 lg:pt-0">
                   <div class="-mx-4 flex overflow-x-auto pb-4 sm:mx-0 sm:overflow-visible sm:pb-0 lg:col-span-2">
                       <div
                           ...
                           <div
                               ...
                               <h3>
                                   <button
                                       ...
                                       id="headlessui-tabs-tab-:R9d96m:" role="tab" type="button" aria-selected="true"
                                       tabindex="0"><span
                                           class="absolute inset-0 rounded-full lg:rounded-r-none lg:rounded-l-xl"></span>Nossa
                                       história
                                   </button>
                               </h3>
                               <p class="mt-2 hidden text-sm lg:block text-white">uma breve descricao teste teste</p>
                           </div>
                           <div
                               ...
                               <h3>
                                   <button
                                       ...
                                       id="headlessui-tabs-tab-:Rad96m:" role="tab" type="button" aria-selected="false"
                                       tabindex="-1"><span
                                           class="absolute inset-0 rounded-full lg:rounded-r-none lg:rounded-l-xl"></span>Quem
                                       somos
                                   </button>
                               </h3>
                               <p class="mt-2 hidden text-sm lg:block text-blue-100 group-hover:text-white">uma breve
                                   descricao</p></div>
                           <div
                               class="group relative rounded-full py-1 px-4 lg:rounded-r-none lg:rounded-l-xl lg:p-6 hover:bg-white/10 lg:hover:bg-white/5">
                               <h3>
                                   <button
                                       class="font-display text-lg [&amp;:not(:focus-visible)]:focus:outline-none text-blue-100 hover:text-white lg:text-white"
                                       id="headlessui-tabs-tab-:Rbd96m:" role="tab" type="button" aria-selected="false"
                                       tabindex="-1"><span
                                           class="absolute inset-0 rounded-full lg:rounded-r-none lg:rounded-l-xl"></span>O
                                       que fazemos
                                   </button>
                               </h3>
                               <p class="mt-2 hidden text-sm lg:block text-blue-100 group-hover:text-white">uma breve
                           ...
                           <div
                               ...
                               <h3>
                                   <button
                                       class="font-display text-lg [&amp;:not(:focus-visible)]:focus:outline-none text-blue-100 hover:text-white lg:text-white"
                                       id="headlessui-tabs-tab-:Rcd96m:" role="tab" type="button" aria-selected="false"
                                       tabindex="-1"><span
                                           class="absolute inset-0 rounded-full lg:rounded-r-none lg:rounded-l-xl"></span>A
                                       quem se destina
                                   </button>
                               </h3>
                               <p class="mt-2 hidden text-sm lg:block text-blue-100 group-hover:text-white">uma breve
                   ...
                   <div class="lg:col-span-7">
                       <div id="headlessui-tabs-panel-:R1l96m:" role="tabpanel" tabindex="0">
                           <div class="relative sm:px-6 lg:hidden">
                               <div
                                   class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-inset ring-white/10 sm:inset-x-0 sm:rounded-t-xl"></div>
                               <p class="relative mx-auto max-w-2xl text-base text-white sm:text-center">uma breve
                                   descricao teste teste</p></div>
                           <div
                               class="mt-10 w-[45rem] rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[65rem] min-h-128 p-5">
                               <p class="p-2 indent-8 text-justify text-gray-600">Idealizado ao longo de 2021 como
                                   fruto de um sonho de dois profissionais, um do mercado financeiro e outro com
                                   experiência em posições de liderança de grandes empresas nacionais e internacionais,
                                   a AMS Capital é oficialmente lançada em 2023 como uma plataforma de micro crédito
                                   que tem por finalidade – e diferencial – ajudar pessoas e famílias que precisam de
                                   recursos rápido para o fechamento das contas do mês com o menor juros do mercado.
                                   Em 2022 juntaram-se aos idealizadores dois novos profissionais, um da área de TI e
                                   um segundo da área contábil completando o time gestor da AMS Capital. </p></div>
                       </div>
                       <div id="headlessui-tabs-panel-:R2l96m:" role="tabpanel" tabindex="-1" hidden=""
                            style="display:none">
                           <div class="relative sm:px-6 lg:hidden">
                               <div
                                   class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-inset ring-white/10 sm:inset-x-0 sm:rounded-t-xl"></div>
                           ...
                           <div
                               class="mt-10 w-[45rem] rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[65rem] min-h-128 p-5">
                               <p class="p-2 indent-8 text-justify text-gray-600"> Alexandre Stork, é um dos
                                   idealizadores e fundadores da AMS Capital. Executivo Sênior com sólida experiência
                                   nas áreas de Óleo e Gás, Fundos de Private Equity, Educação e Saúde. Coordenou
                                   processos de turnaround e esteve envolvido em processos de M&amp;A como comprador e
                                   vendedor no Brasil e no exterior.
                                   Antes de fundar a AMS Capital, Stork – como é conhecido, foi Diretor Financeiro da
                                   Fundação do Câncer, Country Manager da Harris Pye e Diretor Executivo da HI
                                   Force/LKL Serviços, ambas britânicas que atuam nos setores de Óleo e Gás/Naval.
                                   Atuou, também, como Controller de instituição de saúde e educação no Brasil. Teve
                                   passagem marcante pelo Ministério da Saúde, onde foi um dos formuladores da Política
                                   Nacional de Custos em Saúde, além do Programa Nacional e Custos em Saúde.
                                   Stork é carioca, Economista pela Federal do Rio de Janeiro, com MBA em Gestão
                                   Empresarial com diploma emitido pelas Universidade do Grande Rio e Universidade do
                                   Hawaii, tem 43 anos.
                               </p>
                               <p class="p-2 indent-8 text-justify text-gray-600">Andressa Martins, é também uma das
                                   idealizadoras e fundadora da AMS Capital, possui larga experiência no mercado
                                   financeiro, atuando em renda fixa e renda variável, incluindo operações de trade.
                                   Antes de fundar a AMS Capital, Andressa era gestora de recursos em renda fixa da
                                   A3B2 Empreendimentos que depois foi incorporada pela YPEXPAY Financeira.
                                   Formada em Engenharia Ambiental, atuou boa parte de sua carreira na área comercial,
                                   chegando ao mercado financeiro em 2021.
                                   Andressa, também é Agente Autônoma de Investimentos e possui pós graduação em
                                   Mercado Financeiro e Banking pela PUC-PR.</p>
                               <p class="p-2 indent-8 text-justify text-gray-600">Andressa Martins, é também uma das
                                   idealizadoras e fundadora da AMS Capital, possui larga experiência no mercado
                                   financeiro, atuando em renda fixa e renda variável, incluindo operações de trade.
                                   Antes de fundar a AMS Capital, Andressa era gestora de recursos em renda fixa da
                               ...
                               <p class="p-2 indent-8 text-justify text-gray-600">Andressa Martins, é também uma das
                                   ...
                                   chegando ao mercado financeiro em 2021.
                                   Andressa, também é Agente Autônoma de Investimentos e possui pós graduação em
                                   Mercado Financeiro e Banking pela PUC-PR.</p></div>
                       </div>
                       <div id="headlessui-tabs-panel-:R3l96m:" role="tabpanel" tabindex="-1" hidden=""
                            style="display:none">
                           <div class="relative sm:px-6 lg:hidden">
                               <div
                                   class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-inset ring-white/10 sm:inset-x-0 sm:rounded-t-xl"></div>
                           ...
                           <div
                               class="mt-10 w-[45rem] rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[65rem] min-h-128 p-5">
                               <p class="p-2 indent-8 text-justify text-gray-600">Após conhecer os detalhes
                                   operacionais do mercado financeiro, os fundadores da AMS identificaram que o Brasil
                                   ainda possui um mercado de micro crédito muito incipiente. Diferente de outras
                                   linhas de crédito que visam investimentos, o objeto da AMS Capital e ajudar as
                                   famílias ou pessoas que precisem de dinheiro quando por alguma intercorrência o
                                   orçamento do mês fica prejudicado. AO invés de recorrer a empréstimo de longo prazo
                                   com juros elevados, e que em alguns casos – obrigam o tomador de crédito pegar além
                                   do que precisam – nosso objetivo é ajudar as famílias a recorrerem a um recursos do
                                   tamanho de sua necessidade, rápido, sem burocracias e que atenda o fechamento de
                                   seus orçamentos no mês.</p></div>
                       </div>
                       <div id="headlessui-tabs-panel-:R4l96m:" role="tabpanel" tabindex="-1" hidden=""
                            style="display:none">
                           <div class="relative sm:px-6 lg:hidden">
                               <div
                                   class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-inset ring-white/10 sm:inset-x-0 sm:rounded-t-xl"></div>
                           ...
                           <div
                               class="mt-10 w-[45rem] rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[65rem] min-h-128 p-5">
                               <p class="p-2 indent-8 text-justify text-gray-600">A AMS Capital tem como negócio o
                                   oferecimento de microcrédito a pessoas e famílias que precisem de dinheiro quando
                                   por alguma intercorrência o orçamento do mês fica prejudicado. Além disso,
                                   acreditamos que é possível oferecer microcrédito a juros civilizados que consiga
                                   remunerar nossos investidores, assim como, facilite o pagamento das parcelas pelos
                                   tomadores de empréstimo sendo assim uma solução financeira a nossos clientes, não um
                                   problema.</p></div>
                       </div>
                   </div>
               </div>
       ...
       <section id="secondary-features" aria-label="Features for simplifying everyday business tasks"
           ...
           <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
               <div class="mx-auto max-w-2xl md:text-center"><h2
                       class="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">Simplify everyday
                       business tasks.</h2>
                   <p class="mt-4 text-lg tracking-tight text-slate-700">Because you’d probably be a little confused if
                       we suggested you complicate your everyday business tasks instead.</p></div>
                       ...
                       <div class="mx-auto max-w-2xl">
                           <div class="w-9 rounded-lg bg-blue-600">
                               <svg aria-hidden="true" class="h-9 w-9" fill="none">
                                   <defs>
                                       <linearGradient id=":Rapmm:" x1="11.5" y1="18" x2="36" y2="15.5"
                                                       gradientUnits="userSpaceOnUse">
                                           <stop offset=".194" stop-color="#fff"></stop>
                                           <stop offset="1" stop-color="#6692F1"></stop>
                                       </linearGradient>
                                   </defs>
                                   <path d="m30 15-4 5-4-11-4 18-4-11-4 7-4-5" stroke="url(#:Rapmm:)" stroke-width="2"
                       ...
                       <div class="relative mt-10 pb-10">
                           ...
                           <div
                               ...
                               <img alt="" sizes="52.75rem"
                                    ...
                                    width="1688" height="856" decoding="async" data-nimg="future" class="w-full"
                                    loading="lazy"/></div>
                       </div>
                   </div>
                   <div>
                   ...
                   <div class="grid grid-cols-3 gap-x-8" role="tablist" aria-orientation="horizontal">
                       <div class="relative">
                           <div class="w-9 rounded-lg bg-blue-600">
                               <svg aria-hidden="true" class="h-9 w-9" fill="none">
                                   <defs>
                                       <linearGradient id=":R1bdmm:" x1="11.5" y1="18" x2="36" y2="15.5"
                                                       gradientUnits="userSpaceOnUse">
                                           <stop offset=".194" stop-color="#fff"></stop>
                                           <stop offset="1" stop-color="#6692F1"></stop>
                                       </linearGradient>
                                   </defs>
                                   <path d="m30 15-4 5-4-11-4 18-4-11-4 7-4-5" stroke="url(#:R1bdmm:)" stroke-width="2"
                                         stroke-linecap="round" stroke-linejoin="round"></path>
                               </svg>
                           </div>
                           <h3 class="mt-6 text-sm font-medium text-blue-600">
                               <button class="[&amp;:not(:focus-visible)]:focus:outline-none"
                                       id="headlessui-tabs-tab-:R2bdmm:" role="tab" type="button" aria-selected="true"
                                       tabindex="0"><span class="absolute inset-0"></span>Reporting
                               </button>
                           </h3>
                           <p class="mt-2 font-display text-xl text-slate-900">Stay on top of things with always
                               up-to-date reporting features.</p>
                       ...
                       <div class="relative opacity-75 hover:opacity-100">
                           ...
                           <h3 class="mt-6 text-sm font-medium text-slate-600">
                               <button class="[&amp;:not(:focus-visible)]:focus:outline-none"
                                       id="headlessui-tabs-tab-:R2jdmm:" role="tab" type="button" aria-selected="false"
                                       tabindex="-1"><span class="absolute inset-0"></span>Inventory
                               </button>
                           </h3>
                           <p class="mt-2 font-display text-xl text-slate-900">Never lose track of what’s in stock with
                               accurate inventory tracking.</p>
                       ...
                       <div class="relative opacity-75 hover:opacity-100">
                           ...
                           <h3 class="mt-6 text-sm font-medium text-slate-600">
                               <button class="[&amp;:not(:focus-visible)]:focus:outline-none"
                                       id="headlessui-tabs-tab-:R2rdmm:" role="tab" type="button" aria-selected="false"
                                       tabindex="-1"><span class="absolute inset-0"></span>Contacts
                               </button>
                           </h3>
                           <p class="mt-2 font-display text-xl text-slate-900">Organize all of your contacts, service
                               providers, and invoices in one place.</p>
                   ...
                   <div class="relative mt-20 overflow-hidden rounded-4xl bg-slate-200 px-14 py-16 xl:px-16">
                       <div class="-mx-5 flex">
                           <div
                               ...
                               id="headlessui-tabs-panel-:R1ddmm:" role="tabpanel" tabindex="0">
                               <div
                           ...
                           <div
                               ...
                               style="transform:translateX(-0%)" aria-hidden="true" id="headlessui-tabs-panel-:R2ddmm:"
                           ...
                           <div
                               class="px-5 transition duration-500 ease-in-out [&amp;:not(:focus-visible)]:focus:outline-none opacity-60"
                               style="transform:translateX(-0%)" aria-hidden="true" id="headlessui-tabs-panel-:R3ddmm:"
                               role="tabpanel" tabindex="-1">
                               <div
                                   class="w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
                                   <img alt="" sizes="52.75rem"
                       ...
                       <div
                           class="pointer-events-none absolute inset-0 rounded-4xl ring-1 ring-inset ring-slate-900/10"></div>
                   </div>
               </div>
           </div>
       </section>
           ...
           <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
               <div class="mx-auto max-w-lg text-center"><h2
                   ...
                   <p class="mt-4 text-lg tracking-tight text-white">It’s time to take control of your books. Buy our
                       ...
                       href="/register">Get 6 months free</a></div>
           </div>
       </section>
                       ...
                       <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                           <li>
                               <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                   ...
                                   <blockquote class="relative"><p class="text-lg tracking-tight text-slate-900">TaxPal
                                           is so easy to use I can’t help but wonder if it’s really doing the things
                                           the government expects me to do.</p></blockquote>
                                   <figcaption
                           ...
                           <li>
                               <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                   ...
                                   <blockquote class="relative"><p class="text-lg tracking-tight text-slate-900">I’m
                                           trying to get a hold of someone in support, I’m in a lot of trouble right
                                           now and they are saying it has something to do with my books. Please get
                                           back to me right away.</p></blockquote>
                                   <figcaption
                                       class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                                       <div>
                       ...
                       <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                           <li>
                               <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                   ...
                                   <blockquote class="relative"><p class="text-lg tracking-tight text-slate-900">The
                                           best part about TaxPal is every time I pay my employees, my bank balance
                                           doesn’t go down like it used to. Looking forward to spending this extra cash
                                           when I figure out why my card is being declined.</p></blockquote>
                                   <figcaption
                                       class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                                       <div>
                           ...
                           <li>
                               <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                   ...
                                   <blockquote class="relative"><p class="text-lg tracking-tight text-slate-900">There
                                           are so many things I had to do with my old software that I just don’t do at
                                           all with TaxPal. Suspicious but I can’t say I don’t love it.</p>
                                   </blockquote>
                                   <figcaption
                                       class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                                       <div>
                       ...
                       <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                           <li>
                               <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                   ...
                                   <blockquote class="relative"><p class="text-lg tracking-tight text-slate-900">I used
                                           to have to remit tax to the EU and with TaxPal I somehow don’t have to do
                                           that anymore. Nervous to travel there now though.</p></blockquote>
                                   <figcaption
                                       class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                                       <div>
                           ...
                           <li>
                               <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                   ...
                                   <blockquote class="relative"><p class="text-lg tracking-tight text-slate-900">This
                                           is the fourth email I’ve sent to your support team. I am literally being
                                           held in jail for tax fraud. Please answer your damn emails, this is
               ...
               <div class="md:text-center">
                   <h2 class="font-display text-3xl tracking-tight text-white sm:text-4xl"><span
                           class="relative whitespace-nowrap"><svg aria-hidden="true" viewBox="0 0 281 40"
                                                                   ...
                                                                   preserveAspectRatio="none"><path fill-rule="evenodd"
                                                                                                    clip-rule="evenodd"
               ...
               <div
                   ...
                   <section class="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8"><h3
                       ...
                       <a class="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-700 text-white hover:ring-slate-500 active:ring-slate-700 active:text-slate-400 focus-visible:outline-white mt-8"
                          aria-label="Get started with Starter plan for $9" href="/register">Get started</a></section>
                   <section class="flex flex-col rounded-3xl px-6 sm:px-8 order-first bg-blue-600 py-8 lg:order-none">
                       ...
                       <a class="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-white text-slate-900 hover:bg-blue-50 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white mt-8"
                          aria-label="Get started with Small business plan for $15" href="/register">Get started</a>
                   </section>
                   <section class="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8"><h3
                       ...
                       <a class="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-700 text-white hover:ring-slate-500 active:ring-slate-700 active:text-slate-400 focus-visible:outline-white mt-8"
                          aria-label="Get started with Enterprise plan for $39" href="/register">Get started</a>
                   </section>
               </div>
           </div>
       </section>
   ...
   <footer class="bg-slate-50">
       <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
           ...
           <div
               ...
               <p class="mt-6 text-sm text-slate-500 sm:mt-0">Copyright © <!-- -->2022<!-- --> TaxPal. All rights
                   reserved.</p></div>
       </div>
   </footer>
</div>
